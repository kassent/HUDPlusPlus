...
package scaleform.clik.events {
    ...
    // Initialization:
        public function ButtonEvent(type:String, bubbles:Boolean = true, cancelable:Boolean = false, 
                                    controllerIdx:uint = 0, isKeyboard:Boolean = false, isRepeat:Boolean = false) {
    ...
    // Public Methods:
        override public function clone():Event {
            return new ButtonEvent(type, bubbles, cancelable, controllerIdx, isKeyboard, isRepeat);
        }
        
        override public function toString():String {
            return formatToString("ButtonEvent", "type", "bubbles", "cancelable", "controllerIdx", "isKeyboard", "isRepeat");
        }
