...
package scaleform.clik.controls {
    ...
    // Protected Properties:
        ...
        protected var _owner:UIComponent; // Reference to the owner of this ListItemRenderer
    ...
    // Public Getter / Setters:
        ...
        /** Reference to the owner of this ListItemRenderer (generally, a subclass of CoreList). */
        ...
        override public function set selected(value:Boolean):void {
            ...
            var willDisplayFocus:Boolean = false;
            var ownerFocusTarget:Object = null;
            if (value && owner) {
                willDisplayFocus = owner.focused > 0; // Check whether the owner is focused.
                // if the owner wasn't focused, check whether it had a focus target (eg. ScrollingList in a DropDownMenu).
                if (!willDisplayFocus) { ownerFocusTarget = owner.focusTarget; } 
                if (ownerFocusTarget && ownerFocusTarget.focused > 0) { willDisplayFocus = true; }
            }
            
            displayFocus = (value && willDisplayFocus);
        }
